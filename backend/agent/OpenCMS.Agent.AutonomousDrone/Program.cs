...
var autonomousDrone = new AutonomousDrone(agentState, loggerFactory.CreateLogger<AutonomousDrone>());
    ...
    try
    {
        ...
        foreach (var activeOperation in activeOperations)
        {
            ...
            foreach (var order in operation.Orders)
            {
                ...
                await autonomousDrone.TakePosition(new Asset
                {
