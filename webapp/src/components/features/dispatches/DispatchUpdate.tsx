...
export const DispatchUpdate: React.FC = observer(() => {
    ...
    const formik = useFormik<FormValues>({
        ...
        initialValues: {
            ...
            category: item?.category ?? DispatchApi.Enums.DispatchCategories.General,
            occuredAt: item?.occuredAt ?? '',
            relatedEntityId: item?.relatedEntityId ?? '00000000-0000-0000-0000-000000000000',
            relatedChildEntityId: item?.relatedChildEntityId ?? null,
