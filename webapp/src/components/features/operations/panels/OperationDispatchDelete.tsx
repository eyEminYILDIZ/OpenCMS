...
export const OperationDispatchDelete: React.FC = observer(() => {
    ...
    return (
        <>
            <h4>{t('operation.deleteDispatch.title')}</h4>
            ...
            <br />
            <h5>{t('operation.deleteDispatch.confirmMessage')}</h5>
            <ButtonStack>
                <Button variant="destructive" onClick={() => { operationStore.deleteDispatch(); }}>
                    <Trash2 size={16} />
                    {t('common.delete')}
                </Button>
