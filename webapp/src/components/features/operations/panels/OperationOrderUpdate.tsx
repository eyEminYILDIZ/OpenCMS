...
type FormValues = Omit<OperationApi.Orders.Update.Request, 'id'>;

export const OperationOrderUpdate: React.FC = observer(() => {
    ...
    const formik = useFormik<FormValues>({
        ...
        initialValues: {
            ...
            targetPointLatitude: order?.targetPointLatitude ?? 0,
            targetPointLongitude: order?.targetPointLongitude ?? 0,
        ...
        onSubmit: async (values) => {
            await operationStore.updateOrder(values);
        },
    });
